...
import RegionsComponent from './../../../../../../src/pages/Contacts/ui/RegionsComponent/RegionsComponent.vue';
import { regionsList } from '../../../../../../src/pages/Contacts/config/regions.config';
